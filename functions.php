...
function startseite_styles() {
	if ( is_page_template('startseite.php') )
   	wp_enqueue_style( 'Startseite', get_stylesheet_directory_uri() . '/css/startseite.css' );
}
add_action( 'wp_enqueue_scripts', 'startseite_styles', 101 );
