	...
	<div class="wrapper">
		...
		<div class="" id="field1">
			<div class="_form-title">
				<h2>Beantworte wenige Fragen</h2>
			</div>
			<a onclick="slide(event)">
			<div class="button_dark next slide" onclick="slide(event)">
		...
		<div class="element" id="field2">
			<div class="flex">
				...
				<div class="leiste">
					...
					<i class="fas fa-chevron-right inner next slide" onclick="slide(event)"></i>
				</div>
		...
		<div class="element" id="field6">
			<div class="flex">
				<h2>Wie sieht die Datensicherheit in deinem Unternhemen aus?</h2>
				<div class="leiste">
					<input type="text" name="" value="">
					<i class="fas fa-chevron-right inner next slide" onclick="slide(event)"></i>
				</div>
		...
		<div class="element" id="field8">
			<div class="flex">
				<h2>Klicke jetzt auf den Button</h2>
...
<section id="header">
	<div class="wrapper">
		<div class="absolute heading">
			...
			<a href="#schritt1" class="button start slide" onclick="slide(event)">
				<span>Button</span>
			</a>
		</div>
	</div>
